...
public class UpdateContractController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Date datestart = Date.valueOf(request.getParameter("startdate"));
        Date dateend = Date.valueOf(request.getParameter("enddate"));
        ContractDAO contract = new ContractDAO();
        contract.UpdateContract(id, datestart, dateend, "Active");
