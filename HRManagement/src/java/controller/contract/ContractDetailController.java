 ...
 * @author Duc Huy
 */
@WebServlet(name = "ContractDetailController", urlPatterns = {"/contract"})
public class ContractDetailController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Contract> list = contract.getContractListByStaffId(id);

        request.setAttribute("contract", list);
        contract.close();
